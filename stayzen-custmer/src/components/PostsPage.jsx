        ...
        <div className="ps-container">
            ...
            {isEditModalOpen && (
                <div className="pp-modal-overlay">
                    <div className="pp-modal-content" style={{ width: '700px', maxHeight: '90vh', overflowY: 'auto' }}>
                        ...
                        <div className="pp-modal-body">
                            ...
                            {editForm.propertyType === 'Apartment' ? (
                                ...
                                <div className="pp-form-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
                                    <div className="pp-form-group">
                                        <label>PG Type</label>
                                        <select name="unitType" value={editForm.unitType} onChange={handleEditInputChange} className="pp-form-select">
